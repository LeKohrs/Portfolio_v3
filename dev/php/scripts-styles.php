...
if(!function_exists('abessive_scripts_method')) {
    function abessive_scripts_method()
    {
        ...
        wp_enqueue_script('abessive_app', get_template_directory_uri() . '/js/vendor/TweenMax.min.js','', '', true);
        wp_enqueue_script('abessive_app', get_template_directory_uri() . '/js/vendor/TimelineMax.min.js','', '', true);
